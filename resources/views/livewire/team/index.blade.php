            ...
            <table class="table table-index w-full">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.team.fields.create_at') }}
                        ...
                        <th>
                            {{ trans('cruds.team.fields.age') }}
                            @include('components.table.sort', ['field' => 'age'])
                        </th>
                        <th>
                            {{ trans('cruds.team.fields.level_id') }}
                            @include('components.table.sort', ['field' => 'level_id'])
                        </th>
                        <th>
                            {{ trans('cruds.team.fields.total_member') }}
                        </th>
                        <th>
                        </th>
                    </tr>
                ...
                <tbody>
                    @forelse($teams as $team)
                        <tr>
                            ...
                            <td>
                                {{ $team->created_at?->format('M-d-Y h:i:s A') ?? '__' }}
                            </td>
                            <td>
                                @if ($team->creator)
                                ...
                                <div class="flex justify-end">
                                    ...
                                    @can('team_delete')
                                        <button class="btn btn-sm btn-rose mr-2" type="button"
                                            wire:click="confirm('delete', {{ $team->id }})"
