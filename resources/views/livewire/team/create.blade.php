<form wire:submit.prevent="submit" class="pt-3">
    ...
    <div class="form-group {{ $errors->has('mediaCollections.team_avatar_image') ? 'invalid' : '' }}">
        ...
        <x-dropzone acceptedFiles="image/*" id="team_avatar_image" name="team_avatar_image" action="{{ route('admin.teams.storeMedia') }}"
    ...
    <div class="form-group {{ $errors->has('mediaCollections.team_background') ? 'invalid' : '' }}">
        ...
        <x-dropzone acceptedFiles="image/*" id="team_background" name="team_background" action="{{ route('admin.teams.storeMedia') }}"
    ...
    <div class="form-group {{ $errors->has('team.creator_id') ? 'invalid' : '' }}">
        <label class="form-label required" for="creator">{{ trans('cruds.team.fields.creator') }}</label>
    ...
    <div class="form-group {{ $errors->has('team.gender') ? 'invalid' : '' }}">
        <label class="form-label required">{{ trans('cruds.team.fields.gender') }}</label>
    ...
    <div class="form-group {{ $errors->has('team.age_group') ? 'invalid' : '' }}">
        <label class="form-label required">{{ trans('cruds.team.fields.age_group') }}</label>
        <select class="form-control" wire:model="team.age_group">
            <option value="null" disabled>{{ trans('global.pleaseSelect') }}...</option>
        ...
        <div class="validation-message">
            {{ $errors->first('team.age_group') }}
        </div>
        <div class="help-block">
            {{ trans('cruds.team.fields.age_group_helper') }}
        </div>
    </div>
    <div class="form-group {{ $errors->has('team.level_id') ? 'invalid' : '' }}">
        <label class="form-label required">{{ trans('cruds.team.fields.level_id') }}</label>
