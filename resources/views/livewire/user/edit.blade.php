<form wire:submit.prevent="submit" class="pt-3">
    ...
    <div class="form-group {{ $errors->has('user.currency_id') ? 'invalid' : '' }}">
    ...
    @if ($this->type != 'cms')
        ...
        <div class="form-group {{ $errors->has('user.ec_main_pcode') ? 'invalid' : '' }}">
            <label class="form-label required">{{ trans('cruds.user.fields.ec_main_pcode') }}</label>
        ...
        <div class="form-group {{ $errors->has('user.ec_alt_pcode') ? 'invalid' : '' }}">
            <label class="form-label required">{{ trans('cruds.user.fields.ec_alt_pcode') }}</label>
