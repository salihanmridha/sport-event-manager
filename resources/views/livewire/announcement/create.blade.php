<form wire:submit.prevent="submit" class="pt-3">
    ...
    <div class="form-group {{ $errors->has('announcement.about') ? 'invalid' : '' }}">
        ...
        <textarea class="form-control" name="about" id="about" wire:model="announcement.about" rows="4"  step="1"></textarea>
        <div class="validation-message">
            {{ $errors->first('announcement.about') }}
        </div>
        <div class="help-block">
            {{ trans('cruds.announcement.fields.about_helper') }}
        </div>
    </div>
    ...
    <div class="form-group {{ $errors->has('announcement.end_date') ? 'invalid' : '' }}">
        <label class="form-label" for="end_date_time">{{ trans('cruds.announcement.fields.end_date') }}</label>
